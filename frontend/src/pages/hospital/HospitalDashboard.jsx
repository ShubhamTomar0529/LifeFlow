  ...
  useEffect(() => {
    const fetchHospitalData = async () => {
      try {
        ...
        const profileRes = await fetch("https://lifeflow-backend-z9b4.onrender.com/api/facility/profile", {
        ...
        // Fetch blood stock
        const stockRes = await axios.get("https://lifeflow-backend-z9b4.onrender.com/api/hospital/blood/stock", {
          headers: { Authorization: `Bearer ${token}` },
        });

        // Fetch blood requests
        const requestsRes = await axios.get("https://lifeflow-backend-z9b4.onrender.com/api/hospital/blood/requests", {
          headers: { Authorization: `Bearer ${token}` },
        });
